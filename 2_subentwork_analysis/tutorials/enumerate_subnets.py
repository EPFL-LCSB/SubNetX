...
# User input
num_pthw = 100
prepared_model = True # if the pruned model with binary variables is saved


path_load = path_mod + '/{}/iJO1366 based on the latest in BiGG_{}.json'
path_save = path_mod + '/{}/iJO1366 based on the latest in BiGG_post-analysis_{}.json'
...
def enumerator(index, model, target_rxn):
    ...
    ret = {
        # 'index' : index,
        'available_substrate' : - model.reactions.EX_glc__D_e.lower_bound,
        }
